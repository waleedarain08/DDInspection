        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={{flex: 2}}>
            ...
            <View
              ...
              />
              <Text style={{color: '#9ea1aa', fontSize: 12, paddingLeft: 10}}>
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={{flex: 2}}>
            <View
              ...
              />
              <Text style={{color: '#fff', fontSize: 10}}>Mar 16 - 2:30PM</Text>
            </View>
            <View
              style={{
                flexDirection: 'row',
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={{flex: 2}}>
            <View
              ...
              />
              <Text style={{color: '#fff', fontSize: 10}}>Feb 17 - 9:00AM</Text>
            </View>
            <View
              style={{
                flexDirection: 'row',
