                ...
                return (
                    ...
                    <View style={{flexDirection:"row",justifyContent:"space-between",paddingVertical:12}}>
                        ...
                        <View style={styles.buttonEster}>
                            <Text style={{color:"#ffffff",fontSize:12,textAlign:"center",paddingTop:3}}>{item.title}</Text>
                        </View>
                        <Text style={{color:"#2b3036",fontSize:17,fontWeight:"bold"}}>Deck/Porch</Text>
                        <Text style={{color:"#abaeb3"}}>Repair Dry Rot</Text>
                        </View>
                        <Text style={{flex:1, color:"#4a4e59",fontWeight:"bold",fontSize:18,paddingRight:6}}>$444.95</Text>
                        <View style={{flex:0}}>
