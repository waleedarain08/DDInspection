...
export default function EstimateItem({ navigation }) {
  ...
  return (
    <ScrollView style={styles.MainContainer}>
      <View style={{  paddingVertical: 10, paddingHorizontal: 15 }}>
        ...
        <FlatList
          ...
          renderItem={({ item, index }) => {
            ...
            return (
              <>
                <View style={{ flexDirection: "row", justifyContent: "space-around", paddingVertical: 10,paddingHorizontal:6 }}>
                  <View>
        ...
        <TouchableOpacity activeOpacity={0.9} onPress={imageSelector} style={{ borderStyle: 'dashed', borderRadius: 10, width: 100, height: 100, borderWidth: 1, borderColor: "#b0aeb9",marginVertical:10 }}>
      ...
      <View style={{
        flexDirection: "row", justifyContent: "space-between", paddingHorizontal: 20, paddingVertical: 20, paddingLeft: 30, borderWidth: 1,
